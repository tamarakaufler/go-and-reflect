...
func TestCustomMarshalling() {
	log.Println("========================= custom marshal1 ============================")
	u2 := User2{
		Name: "Amy",
		Age:  35,
...
func unmarshalMe(b []byte, dst interface{}) error {
	...
	msCfg := &mapstructure.DecoderConfig{
		// DecodeHook does not work recursively for maps of maps.
		// Each embedded struct needs to have custom unmarshalling, see marshal2 implementation.
